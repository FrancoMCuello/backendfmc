...
import com.miPortfolio.PortfolioFMC.Entity.Educacion;
import com.miPortfolio.PortfolioFMC.Security.Controller.Mensaje;
import com.miPortfolio.PortfolioFMC.Dto.dtoEducacion;
import com.miPortfolio.PortfolioFMC.Service.SEducacion;
...
public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
    ...
    Educacion educacion = new Educacion (dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(), dtoeducacion.getFechaIE(), dtoeducacion.getFechaFE());
...
public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
    ...
    educacion.setFechaIE(dtoeducacion.getFechaIE());
    educacion.setFechaFE(dtoeducacion.getFechaFE());
